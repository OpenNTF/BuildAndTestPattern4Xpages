...
public class StarterContributor extends XspContributor {
	public static final String STARTER_IMPLICITOBJECTS_FACTORY = Activator.PLUGIN_ID + ".implicit.IMPLICIT_OBJECT_FACTORY";
	public static final String STARTER_ELBINDING_FACTORY = Activator.PLUGIN_ID + ".implicit.ELBINDING_FACTORY";
